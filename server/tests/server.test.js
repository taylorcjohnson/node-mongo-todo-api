...
describe('GET /todos/:id', () => {
  ...
  it('should not return todo doc creating by other use', done => {
    request(app)
  ...
  it('should return a 404 if invalid todo id', done => {
    request(app)
      .get('/todos/123')
      .set('x-auth', users[0].tokens[0].token)
      .expect(404)
...
describe('DELETE /todos/:id', () => {
  ...
  it('should not remove a todo from a different user', done => {
